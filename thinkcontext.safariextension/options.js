...
safari.self.addEventListener(
	...
	onResponse(message)});
safari.self.tab.dispatchMessage('sendOptions','sendOptions',{ kind: 'sendOptions' });
...
function saveOptions(){
    ...
    safari.self.tab.dispatchMessage('saveOptions',{kind: 'saveOptions', campaigns: camps, options: {'opt_popD': $("[name='popD']").val()}});
    campaigns = camps;
